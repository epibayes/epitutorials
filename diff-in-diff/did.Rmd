...
1. Variation on socieconomic status (SES) and social power.
...
However, for most problems involving some kind of **spatial exposure**, e.g. to a neighborhood environment, it is either unethical, impractical, or impossible to randomize people to different neighborhoods. So, what happens when high- or low-risk individuals are over-represented in one group vs. another?

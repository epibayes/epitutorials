...
description: "Spatial Clustering Metrics and their Use in Epidemiological Research"
---
...
grid_plot <- function(df) {
  ...
  g <- ggplot(df, aes(x = x, y = y, fill = p)) +
    ...
    scale_fill_binned_sequential(
      ...
      guide = "coloursteps",
      aesthetics = "fill",
      name = stringr::str_wrap("Proportion Unvaccinated", 20),
      limits = c(0, 1),
      show.limits = TRUE,
      oob = scales::squish,
    ) + ##NOTE: SHOW.LIMITS IS NOT WORKING
    theme_bw() +
    coord_equal() +
    theme(

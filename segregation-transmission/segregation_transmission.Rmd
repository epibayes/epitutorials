...
```{r, fig.align="center", echo=FALSE, out.width="50%", fig.cap="*An SIR model with two groups: one for majority and one for minority.*"}
knitr::include_graphics("images/sir_flow.png")
```
